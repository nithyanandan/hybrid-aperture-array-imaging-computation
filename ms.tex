...
% \end{align}
for gridding (parenthesis) and two-dimensional FFT (outer summation) of electrical fields with an angular resolution corresponding to the full array layout including all stations. The intensities are produced by squaring and accumulation as
\begin{align}
