...
$\boldsymbol{\sigma}_l$ will denote pixel locations within a selected station's resolution solid angle element centred on $\hat{\boldsymbol{s}}_k$, and $\boldsymbol{r}_{m}$ denotes the centroid location of station $m$. \textbf{Table~\ref{tab:intra-inter-station-coherent-imaging} summarises the computational costs of intra- and inter-station processing.} 
